...
process DORADO_DUPLEX {
	...
	publishDir "${params.out_dir}/03_dorado_duplex/", pattern: "*", mode: "copy"
	//publishDir "${params.out_dir}/01_guppy/", pattern: "fastq", mode: "copy"
	//publishDir "${params.out_dir}/01_dorado_simplex/", pattern: "sequencing_logs/sequencing_*.*", mode: "copy"
	...
	dorado duplex -t 32 $params.dorado.moddir/$params.dorado.model --read-ids \$SAMPLENAME.read_ids.txt pod5 > \$SAMPLENAME.duplex.bam
